...
sys.path.insert(1, '/storage/kubrick/vkoshkina/scripts/CS_processing')
sys.path.insert(1, './CVS_tracking')
...
import func_for_CVS_stat as CVS_stat
...
def step_of_tracking(CS_tracks_list, ds, data_type, our_time, circ='C', dt_step=3600):
    ...
    coords_Q = CVS_stat.for_DBSCAN(ds[crit][our_time, our_level], th, crit)  
