...
for year in years:
    ...
    for month in tqdm(months):
        ...
        track_folder_new = f'{path_data}/TC_tracks/{data_type}/{data_type}_sigma_{sigma}/tracks_{circ}_params/{year}-{month:02d}'
        ...
        for idx, TC in tqdm(enumerate(TCs), total=len(TCs), desc="Processing TCs"):
            ...
            df = add_parameters_batch(TC, params_config, data_type=data_type, km=77)
