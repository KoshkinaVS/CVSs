...
path_tracks_dir = f'{path_data}/{data_type}/{data_type}_tracks/{tracking_type}/{DBSCAN_name}/tracks_{circ}/'
...
path_dir_data = f'/Volumes/Backup Plus/70RAE/data/LoRes/2010'

ncfile = f'{path_dir_data}/wrfout_d01_2010-01-01_00:00:00'
