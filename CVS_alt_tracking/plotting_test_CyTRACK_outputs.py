...
path_dir_data = '/storage/thalassa/users/vkoshkina/data/CyTRACK'

file_path = f"{path_dir_data}/CyTRACK_output/CyTRACK_output/CyTRACK_NA_2010081400-2010093021_WRF_TC.dat"
...
# 	index=index+diff+1
plt.savefig(f"{path_dir_data}/CyTRACK_testing_tracks.png",bbox_inches="tight")
